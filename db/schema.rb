...
ActiveRecord::Schema.define(version: 20140831154907) do
  ...
  add_index "highlights", ["user_id", "sort_order"], name: "index_highlights_on_user_id_and_sort_order", unique: true, using: :btree
